...
export async function GET(req: Request, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({ error: 'Error al obtener la venta', details: error }, { status: 500 });
  }
}
...
export async function PUT(req: Request, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({ error: 'Error al actualizar la venta', details: error }, { status: 500 });
  }
}
...
export async function DELETE(req: Request, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({ error: 'Error al eliminar la venta', details: error }, { status: 500 });
  }
}
